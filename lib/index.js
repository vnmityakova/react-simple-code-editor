...
var Editor = function (_React$Component) {
  ...
  function Editor() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Editor.__proto__ || Object.getPrototypeOf(Editor)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      stack: [],
      offset: -1
    }, _this.onMenuClick = function (item, selectionStart, value) {
      return function (e) {
        var newValue = [value.slice(0, selectionStart), item, value.slice(selectionStart)].join('');
        _this.setState({ isMenuVisible: false, menu: null });
        _this._handleChange({ target: { value: newValue, selectionStart: selectionStart, selectionEnd: selectionStart } });
      };
      ...
      _this.props.loadMenuItems(e.target.value.substring(0, e.target.selectionStart)).then(function (itemsList) {
        var menu = itemsList.map(function (item, i) {
          return React.createElement(
            'li',
            { key: i, onClick: _this.onMenuClick(item, e.target.selectionStart, e.target.value) },
            item
          );
        });
        _this.setState({ menu: React.createElement(
            'ul',
            null,
            menu
          ) });
  ...
  _createClass(Editor, [{
    ...
    value: function render() {
      ...
      var addClass = this.state.isMenuVisible ? 'visible' : '';
      return React.createElement(
        React.Fragment,
        null,
        React.createElement(
          'div',
          { className: 'menu ' + addClass, style: { top: this.state.top, left: this.state.left } },
          this.state.menu
        ),
        React.createElement(
          'div',
